...
class Repository {
    ...
    getAll(params = null) {
        ...
        if (params) {
            ...
            // order
            filteredAndSortedObjects = this.Sort(filteredAndSortedObjects, sortKeys);
    ...
    Sort(filteredAndSortedObjects, sortKeys) {
        filteredAndSortedObjects.sort((a, b) => {
            let result = 0;
            for (let sortKey of sortKeys) {
                result = this.innerCompare(a[sortKey.key], b[sortKey.key]);
